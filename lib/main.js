    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (core.getInput('action') === "Test") {
                var issue_data = yield client.issues.get({ "owner": "ludeeus", "repo": "hacs-actions", "issue_number": github.context.issue.number });
                console.log(issue_data.data.state);
            }
            yield Selector_1.Selector(core.getInput('modules'), client);
        }
        catch (error) {
