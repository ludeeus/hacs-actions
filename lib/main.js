...
const NewDefaultRepository_1 = require("./packs/NewDefaultRepository");
const ClearTempLabel_1 = require("./packs/ClearTempLabel");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (repository.length !== 0
                ...
                yield CommonCheck_1.CommonCheck(owner, repo, category, client);
                return;
            }
...
function PullRequestActions(client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (contexts_1.Payload.action !== "closed")
            yield NewDefaultRepository_1.NewDefaultRepository(client);
        yield ClearTempLabel_1.ClearTempLabel(client);
    });
}
ExecuteAction();
